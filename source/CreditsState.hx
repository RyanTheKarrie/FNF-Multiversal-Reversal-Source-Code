...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			['Multiversal Reversal Team'],
			['Reyn Keisuke',		'rayana',		'Programmer, Artist/Animator of Multiversal Reversal',						'https://twitter.com/funkinreyn',	'4ABDFF'],
			['Eyuhn Andrius',			'eyuhn',		'Composer of Multiversal Reversal, VA for Rosaline and Reverse Reyn',				'https://twitter.com/ian__andre',		'A556FF'],
			[''],
			['Emotional Support'],
